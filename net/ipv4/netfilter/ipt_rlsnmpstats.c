...
*/
  ...
  len = sprintf(buffer,
		...
		g_rl_data.in_get_request, g_rl_data.in_get_next, g_rl_data.in_set_request,
		g_rl_data.in_get_response, g_rl_data.in_trap,
		/*		g_rl_data.in_silent_drop, g_rl_data.in_proxy_drop, g_rl_data.in_commit_pending_drop,
				g_rl_data.in_throttle_drop,*/
		g_rl_data.out_snmp_packet, g_rl_data.out_too_big, g_rl_data.out_no_such_name,
		g_rl_data.out_bad_val, g_rl_data.out_gen_err,
